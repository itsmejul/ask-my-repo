...
def create_app(config_class="app.config.Config"):
    ...
    CORS(app, origins=[frontend_url, "http://jmosig.com","https://jmosig.com", "https://www.jmosig.com", "http://www.jmosig.com", "http://ask-my-repo.jmosig.com"])  # TODO generate these from env
